...
class FoodRecipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create food_recipe" do
    assert_difference("FoodRecipe.count") do
      post food_recipes_url, params: { food_recipe: { food_id: @food_recipe.food_id, quantity: @food_recipe.quantity, recipe_id: @food_recipe.recipe_id } }
    end
  ...
  test "should update food_recipe" do
    patch food_recipe_url(@food_recipe), params: { food_recipe: { food_id: @food_recipe.food_id, quantity: @food_recipe.quantity, recipe_id: @food_recipe.recipe_id } }
